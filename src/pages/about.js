...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <meta charSet="UTF-8" />
        <title>About Us | High Plains Media - Your Digital Growth Partner</title>
        <meta 
          name="description" 
            ...
            <Row className="align-items-center justify-content-around">
                ...
                <>
                  <Col lg={6}  className="pt-3">
                    <H2>Who we are</H2>
                    <P>
                    We are &quot;out of this world&quot; developers and designers, creating engaging digital experiences across the web. High Plains Media has cultivated a relentless pursuit of excellence in digital transformation. Today, we bring our expertise to small businesses, empowering them to scale and succeed in the digital world.
                    <br /><br />
